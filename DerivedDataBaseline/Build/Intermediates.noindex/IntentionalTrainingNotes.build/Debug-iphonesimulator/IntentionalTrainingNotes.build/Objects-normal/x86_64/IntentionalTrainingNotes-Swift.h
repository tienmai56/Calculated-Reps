...
#ifndef INTENTIONALTRAININGNOTES_SWIFT_H
#define INTENTIONALTRAININGNOTES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IntentionalTrainingNotes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSURL;
SWIFT_CLASS("_TtC24IntentionalTrainingNotes11AppDelegate")
...
SWIFT_CLASS("_TtC24IntentionalTrainingNotes22AppleSignInCoordinator")
@interface AppleSignInCoordinator : NSObject <ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding>
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC24IntentionalTrainingNotes13SceneDelegate")
...
SWIFT_CLASS("_TtC24IntentionalTrainingNotes16UIKitImagePicker")
@interface UIKitImagePicker : NSObject <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
